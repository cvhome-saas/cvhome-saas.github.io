...
![The home page of org1-store1 with its theme's sections](/images/lcl/storefront-home.png)
...
![A product page with the variant selector and the buy box](/images/lcl/storefront-product.png)
...
![The theme's sign-in page at /en/login](/images/lcl/storefront-login.png)
