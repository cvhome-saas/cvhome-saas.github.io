...
<!-- img: /images/lcl/console-login.png — the console's sign-in page at gateway.com:8000 -->
...
<!-- img: /images/lcl/console-dashboard.png — the store dashboard after signing in -->
...
<!-- img: /images/lcl/console-products.png — the products table with price and stock merged from inventory -->
...
<!-- img: /images/lcl/console-storefront-builder.png — the builder with the layer list, the live storefront preview and the inspector -->
...
<!-- img: /images/lcl/console-store-management.png — store management with its section rail and the domain section open -->
...
<!-- img: /images/lcl/console-billing.png — the subscription page with plan cards and invoices -->
